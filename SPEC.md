...
-   [ ] Crear CTA.
-   [ ] Crear ubicación.
-   [ ] Agregar Google Maps cuando se confirme la dirección.
...
-   [ ] El sitio funciona en GitHub Pages.
-   [ ] Es responsive.
-   [ ] No existen emojis en la interfaz.
-   [ ] El negocio se entiende en los primeros segundos.
-   [ ] Se comunica que existe desde 2015.
-   [ ] Los servicios principales son claros.
-   [ ] Existe una galería funcional.
-   [ ] La galería tiene filtros.
-   [ ] Las imágenes pueden ampliarse.
-   [ ] WhatsApp funciona.
-   [ ] La ubicación funciona cuando se agregue la dirección real.
-   [ ] No existen datos inventados.
-   [ ] Las fotografías están optimizadas.
-   [ ] El sitio funciona sin backend.
-   [ ] Agregar una fotografía nueva no requiere modificar manualmente
    el HTML.
-   [ ] El diseño funciona correctamente en móvil.
-   [ ] El código está organizado y documentado.
-   [ ] El proyecto está preparado para crecer a cientos de fotografías.
